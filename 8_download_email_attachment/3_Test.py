import os, glob
for Output in glob.glob("r'F:\\AIS\\Diego_F_Drive_Data\\dispute_monitoring\\data\\Output\\Output"):
    os.remove(Output)
...
for email in emails:
    ...
    if len(attachments) == 0:  # number of attachments
        ...
        for attachment in attachments:
            attachment.SaveAsFile("F:\\AIS\\Diego_F_Drive_Data\\dispute_monitoring\\data\\Output\\Output" + attachment.FileName)
