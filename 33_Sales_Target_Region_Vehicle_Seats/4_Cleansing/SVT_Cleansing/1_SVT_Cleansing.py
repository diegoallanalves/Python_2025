...
report = open('/33_Sales_Target_Region_Vehicle_Seats/4_Cleansing/SVT_Cleansing/SVT_Cleansing_Report.txt', 'w')

# DF3: The isna method returns a DataFrame of all boolean values (True/False).
df3_null1 = df3.isna()
df3_null = df3_null1.sum()
report.write('\n' + '\n' + 'Nulls values by columns in the data: [Parc].[dbo].[SVT_12]  ' + str(df3_null.sum) + '\n' + '\n')

## df3: Missing Data Percentage List
...
doc.save("C:\\Users\\alvesd\\OneDrive - smmt.co.uk\\Desktop\\Diego_work_folder\\python\\4_Cleansing\\SVT_Cleansing\\SVT_Cleansing_Report.docx")
