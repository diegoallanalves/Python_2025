...
# Load order data
orders = pd.read_csv(
    'C:\\Users\\diego\\Desktop\\data_set\\instacart_market_basket_analysis\\order_products_prior.csv\\order_products_prior.csv')
...
print('orders -- dimensions: {0}; size: {1}; unique_orders: {2}; unique_items: {3}'.format(orders.shape, size(orders),
