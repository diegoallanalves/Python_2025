...
# Load the data
df = pd.read_excel(
    f'C:\\Users\\alvesd.SMMT\\OneDrive - smmt.co.uk\\Desktop\\test\\test_SDI_Logs_and_Enquiries_Forum.xlsx',
    'Enquiry Sheet')
...
workbook = xlsxwriter.Workbook(
    'C:\\Users\\alvesd.SMMT\\OneDrive - smmt.co.uk\\Desktop\\test\\Natural Languange Processing.xlsx')
...
# Generate word cloud
wordcloud = WordCloud(width=3000, height=2000, random_state=1, background_color='salmon', colormap='Pastel1',
                      collocations=False, stopwords=STOPWORDS).generate(text1)
# Plot
# plot_cloud(wordcloud)
...
wb.save('C:\\Users\\alvesd.SMMT\\OneDrive - smmt.co.uk\\Desktop\\Forms Charts.xlsx')
